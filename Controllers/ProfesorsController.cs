...
using ASP_NET_ACTIONS.Models;

namespace ASP_NET_ACTIONS.Controllers
{
    public class ProfesorsController : Controller
    {
        private ProfDBContext db = new ProfDBContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Name,JoiningDate,Age")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,JoiningDate,Age")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {
